...
## 🟡 Дефект 5 — Дедупликация событий в памяти теряется при рестарте [✅ ИСПРАВЛЕН]
...
## 🟠 Дефект 6 — Фильтр аутентификации отключён по умолчанию без предупреждения [✅ ИСПРАВЛЕН]
